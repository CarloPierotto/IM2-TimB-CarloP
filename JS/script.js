        ...
        listContainer.innerHTML += `
          <div class="parkhaeuser" id="ph_${ph.id}">
            ...
            <svg id="auto" data-name="Ebene 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.55 43">
                ...
                <path fill="url(#carGradient_${ph.id})" class="cls-1" d="M43.47,43.48c.31-2.7,3.35-3.3,3.35-3.3,1.21-.6,3.48-1.31,6.25-2.05,3.05-.81,6.17-1.27,9.25-1.99,1.88-.44,3.78-.93,5.54-1.74,8.74-4.06,24.94-16.84,34.67-21.2,3.4-1.53,6.22-2.29,9.91-2.75,3.85-.49,85.78.57,89.61,1.23,2.43.42,4.72,1.58,6.85,2.76,2.87,1.6,5.59,3.45,8.26,5.33,3.04,2.13,6.01,4.35,9.02,6.54,3.01,2.19,6,4.35,9.1,6.4,2.73,1.8,5.53,3.53,8.5,4.9,1.5.69,3.01,1.29,4.66,1.55.03,0,.07.02.07.04s-.06.04-.05,0c1.59.17,3.19.31,4.79.44.88.07,1.75.13,2.62.21,1.75.17-8.36-.89-6.6-.7,3.85.4,7.69.82,11.55,1.26,3.55.41,7.08.83,10.62,1.29,2.32.3,4.65.58,6.94,1.03.09.02.19.04.28.06.16.03.32.05.48.08,15.22,3.2,16.74,3.92,17.6,14.74,1.05,13.29-1.52,27.32-18.56,27.93-.02.33-.04.65-.07.99-2.59,25.99-42.85,26.4-45.62-.5h-126.49v.1c-.56,7.55-4.58,14.35-11.46,17.84-6.16,3.14-13.75,3.4-20.14.75-7.84-3.24-11.97-10.34-13.06-18.41-3.82.91-8.12.06-11.54-1.78-3.31-1.78-5.61-4.82-6.86-8.31-1.01-2.81-.77-6.41-.86-9.34-.15-4.75-.15-9.51.05-14.26.13-3.1-.09-6.45,1.4-9.14h-.04Z"/>
            ...
            <div class="free_space">
              ...
              <h4>Freie Plätze: </h4><h2>${apiInfo.free}</h2>
